...
# hum agent ko wo cheezen pas karen jo LLM ko required hon

# run level confi
# agent ko hum run k pas pass kr dete hain isko hum direct pas nhi krte 

# global level configurationuv 
#  open ai ki 
# 
# uv add openai client
